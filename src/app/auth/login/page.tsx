      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-gradient-to-br from-primary to-secondary p-8 rounded-2xl border border-border shadow-2xl">
          <div className="text-center mb-8">
            ...
            <h2 className="text-xl text-foreground">התחברות למערכת</h2>
          ...
          <div className="mt-8 text-center">
            <p className="text-muted-foreground">
              אין לך חשבון?{" "}
              <Link href="/auth/register" className="text-accent hover:text-orange-600 font-semibold transition-colors">
                הרשם עכשיו
              </Link>
            </p>
          </div>
